              ...
              <div className="space-y-8">
                <div className="text-center mb-8">
                  ...
                  <p className="text-gray-300 text-lg">
                    Let's start with the basics. What would you like your chatbot to be called?
                  </p>
                </div>
                ...
                <div className="space-y-8">
                  ...
                  <div>
                    <label className="block text-sm font-medium mb-3">
                      What's the primary purpose of your chatbot?
                    </label>
                      ...
                      {[
                        {
                          ...
                          desc: 'Help customers with questions, issues, and general inquiries',
                          icon: Target,
                        ...
                        },
                        {
                          ...
                          desc: 'Generate leads, qualify prospects, and boost conversions',
                          icon: TrendingUp,
                        ...
                        },
                        {
                          ...
                          desc: 'Provide information and assist with various tasks',
                          icon: MessageSquare,
                        ...
                        return (
                          ...
                          >
                            <div
                              className={`w-12 h-12 bg-gradient-to-r ${purpose.color} rounded-xl flex items-center justify-center mb-4 mx-auto`}
                            >
                  ...
                  <div>
                    ...
                    <p className="text-xs text-gray-400 mt-2">
                      Example: "Always ask for contact details before providing pricing information"
                      or "Be extra helpful with technical questions"
                    </p>
                  </div>
                </div>
            ...
            {currentStep === 2 && (
              <div className="space-y-8">
                <div className="text-center mb-8">
                  ...
                  <p className="text-gray-300 text-lg">
                    Fine-tune how your chatbot responds and behaves.
                  </p>
                </div>
            ...
            {currentStep === 3 && (
              <div className="space-y-8">
                <div className="text-center mb-8">
                  ...
                  <p className="text-gray-300 text-lg">
                    Choose where you want your chatbot to be available for your customers.
                  </p>
                </div>
                    ...
                    <div className="flex items-start space-x-4">
                      ...
                      <div className="flex-1">
                        ...
                        <p className="text-sm text-gray-400 mb-4">
                          Add a chat widget to your website that visitors can use to interact with
                          your chatbot.
                        </p>
                        {formData.channels.website && (
                          <div className="bg-[#1f2024] rounded-lg p-4">
                            ...
                            <code className="text-xs bg-black/50 p-2 rounded block overflow-x-auto text-gray-300">
                              &lt;script src="https://intaj.ai/widget.js"
