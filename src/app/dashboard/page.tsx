      ...
      <aside className="w-80 bg-[#141517] border-r border-gray-700/50 flex flex-col">
        ...
        <nav className="flex-1 p-4 space-y-2">
          ...
          <Link 
            ...
            className={`sidebar-link flex items-center space-x-3 p-3 rounded-lg ${
              pathname.includes('/chatbots') || pathname.includes('/agents') ? 'bg-primary-500/20 text-primary-500' : 'text-gray-400 hover:text-gray-200'
            }`}
          >
            <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
      ...
      <div className="flex-1 flex flex-col overflow-hidden">
        ...
        <main className="flex-1 overflow-y-auto bg-[#0a0a0b] p-8">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 mb-8">
            ...
            {/* Recent Activity */}
            <div className="bg-[#1f2024] glass-card p-6 rounded-2xl" data-tour="agents-section">
              <h3 className="text-xl font-bold text-white mb-6 flex items-center space-x-2">
