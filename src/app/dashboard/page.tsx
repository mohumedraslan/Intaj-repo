          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 mb-8">
            ...
            <div className="bg-[#1f2024] glass-card p-6 rounded-2xl" data-tour="quick-actions">
              ...
              <div className="grid grid-cols-2 gap-4 mb-6">
                <button className="bg-gradient-to-r from-blue-500 to-purple-500 p-4 rounded-lg text-white font-medium hover:opacity-90 transition-opacity flex flex-col items-center space-y-2" data-tour="create-chatbot-btn">
                  <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M8 12h.01M12 12h.01M16 12h.01M21 12c0 4.418-4.03 8-9 8a9.863 9.863 0 01-4.255-.949L3 20l1.395-3.72C3.512 15.042 3 13.574 3 12c0-4.418 4.03-8 9-8s9 3.582 9 8z" /></svg>
                  <span>Create Chatbot</span>
                </button>
                <button className="bg-gradient-to-r from-green-500 to-emerald-500 p-4 rounded-lg text-white font-medium hover:opacity-90 transition-opacity flex flex-col items-center space-y-2">
                  <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M13.828 10.172a4 4 0 00-5.656 0l-4 4a4 4 0 105.656 5.656l1.102-1.101m-.758-4.899a4 4 0 005.656 0l4-4a4 4 0 00-5.656-5.656l-1.1 1.1" /></svg>
                  <span>Connect Channel</span>
                </button>
                <button className="bg-gradient-to-r from-purple-500 to-pink-500 p-4 rounded-lg text-white font-medium hover:opacity-90 transition-opacity flex flex-col items-center space-y-2">
                  <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M17 20h5v-2a3 3 0 00-5.356-1.857M17 20H7m10 0v-2c0-.656-.126-1.283-.356-1.857M7 20H2v-2a3 3 0 015.356-1.857M7 20v-2c0-.656.126-1.283.356-1.857m0 0a5.002 5.002 0 019.288 0M15 7a3 3 0 11-6 0 3 3 0 016 0zm6 3a2 2 0 11-4 0 2 2 0 014 0zM7 10a2 2 0 11-4 0 2 2 0 014 0z" /></svg>
                  <span>Invite Team</span>
                </button>
                <button className="bg-gradient-to-r from-orange-500 to-red-500 p-4 rounded-lg text-white font-medium hover:opacity-90 transition-opacity flex flex-col items-center space-y-2">
