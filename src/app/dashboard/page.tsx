    ...
    <div className="flex h-[100dvh] bg-[#0a0a0b] text-[#f8fafc] font-sans antialiased">
      ...
      <aside className="w-80 bg-[#141517] border-r border-gray-700/50 flex flex-col">
        ...
        <nav className="flex-1 p-4 space-y-2">
          <Link href="/dashboard" className="sidebar-link active flex items-center space-x-3 p-3 rounded-lg text-gray-200">
            <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M3 7v10a2 2 0 002 2h14a2 2 0 002-2V9a2 2 0 00-2-2H5a2 2 0 00-2-2z" /><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M8 5a2 2 0 012-2h4a2 2 0 012 2v6H8V5z" /></svg>
            <span>Dashboard</span>
          </Link>
          <Link href="/connections" className="sidebar-link flex items-center space-x-3 p-3 rounded-lg text-gray-400 hover:text-gray-200">
            <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M13.828 10.172a4 4 0 00-5.656 0l-4 4a4 4 0 105.656 5.656l1.102-1.101m-.758-4.899a4 4 0 005.656 0l4-4a4 4 0 00-5.656-5.656l-1.1 1.1" /></svg>
            <span>Connections</span>
          </Link>
          <Link href="#" className="sidebar-link flex items-center space-x-3 p-3 rounded-lg text-gray-400 hover:text-gray-200">
        ...
        <header className="bg-[#141517] border-b border-gray-700/50 px-8 py-4">
          <div className="flex items-center justify-between">
            ...
            <div className="flex items-center space-x-4">
              ...
              {/* Quick Actions */}
              <button className="bg-gradient-to-r from-blue-500 to-purple-500 px-4 py-2 rounded-lg text-white font-medium hover:opacity-90 transition-opacity flex items-center space-x-2">
        ...
        <main className="flex-1 overflow-y-auto bg-[#0a0a0b] p-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-6 mb-8">
            ...
            <div className="bg-[#1f2024] glass-card p-6 rounded-2xl hover:border-blue-500/30 transition-colors">
              ...
              <div className="text-xs text-green-500 mt-2">+2 this week</div>
            </div>
            ...
            <div className="bg-[#1f2024] glass-card p-6 rounded-2xl hover:border-purple-500/30 transition-colors">
              ...
              <div className="text-xs text-green-500 mt-2">+23% vs yesterday</div>
            </div>
            {/* Response Time */}
            <div className="bg-[#1f2024] glass-card p-6 rounded-2xl hover:border-cyan-500/30 transition-colors">
              ...
              <div className="text-xs text-green-500 mt-2">-0.3s faster</div>
            </div>
            {/* Satisfaction Rate */}
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 mb-8">
            {/* Quick Actions */}
            <div className="bg-[#1f2024] glass-card p-6 rounded-2xl">
              ...
              <div className="space-y-4">
                <div className="flex items-start space-x-4 p-3 bg-[#23242a] rounded-lg">
                  <div className="w-8 h-8 bg-blue-500 rounded-full flex items-center justify-center animate-pulse">
                    <svg className="w-4 h-4 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M8 12h.01M12 12h.01M16 12h.01M21 12c0 4.418-4.03 8-9 8a9.863 9.863 0 01-4.255-.949L3 20l1.395-3.72C3.512 15.042 3 13.574 3 12c0-4.418 4.03-8 9-8s9 3.582 9 8z" /></svg>
                  </div>
                  <div className="flex-1">
                    <div className="text-sm font-medium text-gray-200">Support Bot handled 12 conversations</div>
                ...
                <div className="flex items-start space-x-4 p-3 bg-[#23242a] rounded-lg">
                  ...
                  <div className="flex-1">
                    <div className="text-sm font-medium text-gray-200">Instagram connected successfully</div>
                ...
                <div className="flex items-start space-x-4 p-3 bg-[#23242a] rounded-lg">
                  ...
                  <div className="flex-1">
                    <div className="text-sm font-medium text-gray-200">Knowledge base updated</div>
                ...
                <div className="flex items-start space-x-4 p-3 bg-[#23242a] rounded-lg">
                  ...
                  <div className="flex-1">
                    <div className="text-sm font-medium text-gray-200">New user signed up via Facebook bot</div>
