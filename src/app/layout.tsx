...
export default function RootLayout({
  ...
  return (
    <html lang="en" className="scroll-smooth">
      ...
      >
        {/* Navigation Bar */}
        <header className="w-full bg-[#141517] border-b border-gray-700/50 fixed top-0 left-0 z-50 backdrop-blur-sm bg-opacity-80">
          <div className="max-w-7xl mx-auto px-8 py-4 flex items-center justify-between">
            <div className="flex items-center gap-3">
              ...
              <div>
                <Link href="/" className="text-2xl font-bold bg-gradient-to-r from-blue-500 via-purple-500 to-cyan-400 bg-clip-text text-transparent hover:opacity-90 transition-opacity">Intaj</Link>
                <div className="text-xs text-gray-400">AI Automation Hub</div>
              </div>
            </div>
            <nav className="hidden md:flex items-center gap-8">
              <Link href="/features" className="text-gray-300 hover:text-blue-400 transition-colors text-sm font-medium">Features</Link>
              <Link href="/pricing" className="text-gray-300 hover:text-blue-400 transition-colors text-sm font-medium">Pricing</Link>
              <Link href="/docs" className="text-gray-300 hover:text-blue-400 transition-colors text-sm font-medium">Documentation</Link>
              <Link href="/connections" className="text-gray-300 hover:text-blue-400 transition-colors text-sm font-medium">Connections</Link>
        ...
        {/* Main Content */}
        <main className="w-full min-h-[calc(100vh-4rem)] mt-16">
          {children}
        </main>
