  ...
  return (
    <html lang="en" className="scroll-smooth">
      <head>
        ...
        <meta
          name="description"
          content="Intaj - The AI Automation Platform That Never Sleeps. Transform your business with intelligent chatbots and automation."
        />
              ...
              <div className="grid grid-cols-1 md:grid-cols-4 gap-12">
                ...
                <div className="col-span-1">
                  ...
                  <p className="text-gray-400 text-sm mb-4">
                    Transform your business with intelligent chatbots and seamless automation. Built
                    for the future of customer interaction.
                  </p>
