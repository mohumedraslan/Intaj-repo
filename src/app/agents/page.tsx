...
export default function AgentsPage() {
      ...
      try {
        ...
        const transformedAgents: Agent[] = agents?.map((agent, index) => {
          ...
          return {
            ...
            avatar: getAgentAvatar(agentType, agent.name),
  ...
  const getAgentAvatar = (type: Exclude<AgentType, 'all'>, agentName?: string) => {
    // Use actual photos from /agents photos/ directory
    if (type === 'sales') {
      return (
        <img 
          src="/agents photos/AHMED-sales.png" 
          alt="Sales Agent"
      ...
      return (
        <img 
          src="/agents photos/SARAH-marketing.png" 
          alt="Marketing Agent"
          className="w-full h-full object-cover rounded-full"
        />
      );
      ...
      return (
        <img 
          src="/agents photos/ADAM-customerSupport.png" 
