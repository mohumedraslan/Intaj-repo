...
export async function GET(request: NextRequest) {
  ...
  const errorHtml = `
    ...
    <head>
      ...
      <title>Facebook Webhook - Intaj</title>
      <style>
    ...
    <body>
      <div class="container">
        ...
        <p>This endpoint handles Facebook Messenger webhook verification and message processing.</p>
        
        <div class="steps">
          <div class="step">
            <strong>Webhook URL:</strong><br>
            <div class="code">${process.env.NEXT_PUBLIC_APP_URL || 'http://localhost:3000'}/api/webhooks/facebook</div>
          </div>
          <div class="step">
          ...
          <div class="step">
            ...
            • Navigate to Messenger > Settings<br>
