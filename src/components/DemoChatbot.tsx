...
export default function DemoChatbot() {
  ...
  const initialMessage = {
    ...
    content: "👋 Hi! I'm Intaj AI. Ask me anything about automation, chatbots, or our platform!",
  };
      ...
      const response = await getResponse([
        {
          role: 'system',
          content:
            "You are Intaj AI, a helpful assistant focused on explaining Intaj's AI automation platform features, integrations, and capabilities. Be concise, friendly, and enthusiastic about helping businesses automate their processes.",
        },
        ...messages,
        userMsg,
      ]);
